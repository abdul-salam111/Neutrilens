...
List<GetSuggestedProductModel> getSuggestedProductModelFromJson(String str) =>
    List<GetSuggestedProductModel>.from(
      json.decode(str).map((x) => GetSuggestedProductModel.fromJson(x)),
    );

String getSuggestedProductModelToJson(List<GetSuggestedProductModel> data) =>
